...
app.post("/signup", async(req, res)=>{
  try{
    //deconstruct the user name and password from the body
...
// /logIn - POST - receives a username and password and checks them against the database, and return the user object if they match with a cookie including a signed JWT:
